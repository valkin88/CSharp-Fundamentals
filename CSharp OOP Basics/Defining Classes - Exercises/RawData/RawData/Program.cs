...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            var carsToPrint = cars.Where(c => c.Cargo.Type == carsToPrintByCargoType &&
                                           c.Tires.Any(p => p.Pressure < 1)).ToArray();
            PrintCars(carsToPrint);
    ...
    private static void PrintCars(IEnumerable<Car> carsToPrint)
    {
